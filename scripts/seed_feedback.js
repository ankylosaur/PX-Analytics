...
const FEEDBACK_DATA = [
  ...
  },
  {
    ...
    transcript: "The pediatrics team was wonderful with my daughter. Dr. Joshi made her feel comfortable and even used stuffed animals to explain the procedure. The nurses kept checking on us regularly, which really eased my anxiety as a parent.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    transcript: "Dr. Nair took the time to explain my MRI results in terms I could actually understand. She didn't rush through anything and even drew a diagram to show where the issue was. I left feeling informed and confident about next steps.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    transcript: "My knee replacement follow-up went smoothly. Dr. Rao checked the healing progress carefully and adjusted my physical therapy plan. The front desk was also helpful with scheduling my next three appointments in one go.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Iyer",
    department: "Oncology",
    transcript: "Going through chemotherapy is terrifying, but Dr. Iyer and the oncology nurses made me feel supported every step of the way. They answered all of my questions patiently and checked in on me emotionally, not just physically.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Sen",
    department: "Neurology",
    transcript: "Dr. Sen was fantastic during my neurology consultation. He listened carefully to my description of symptoms and ordered the right tests without making me feel like a number. The entire experience was professional and compassionate.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Gupta",
    department: "Pediatrics",
    transcript: "Dr. Gupta was amazing with my son who has severe needle anxiety. She spent extra time calming him down and used a numbing cream before the injection. My son actually said he wants to come back, which has never happened before!",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Iyer",
    department: "Oncology",
    transcript: "Dr. Iyer sat with me for over thirty minutes to discuss treatment options and their side effects. He made sure I understood the pros and cons of each approach and respected my wish to take a day to decide. I never felt pressured.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Joshi",
    department: "Pediatrics",
    transcript: "Brought my twins in for their vaccinations and Dr. Joshi handled both of them brilliantly. She was gentle, quick, and even gave them stickers and juice boxes afterwards. The whole visit took less than 30 minutes.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Rao",
    department: "Orthopedics",
    transcript: "After my shoulder surgery, Dr. Rao's rehabilitation plan has been spot-on. Every follow-up visit feels thorough and I can clearly see the progress. The physical therapy team he recommended is also outstanding.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Nair",
    department: "Neurology",
    transcript: "I've been dealing with chronic migraines for years and Dr. Nair is the first neurologist who actually listened to my full history. She adjusted my medication and suggested lifestyle changes that have already started helping. Finally feel hopeful.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Gupta",
    department: "Pediatrics",
    transcript: "Dr. Gupta was very thorough during my daughter's annual checkup. She caught a minor issue with her vision that we hadn't noticed and referred us to a specialist right away. Very grateful for her attention to detail.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Sen",
    department: "Neurology",
    transcript: "The neurology department is run like clockwork. I arrived, checked in quickly, and Dr. Sen was ready for me almost immediately. His bedside manner is warm and he explained my EEG results with great clarity.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Iyer",
    department: "Oncology",
    transcript: "The infusion center staff made my treatment session as comfortable as possible. Warm blankets, regular check-ins, and Dr. Iyer stopped by personally to see how I was doing. It's the little things that matter most during cancer treatment.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Rao",
    department: "Orthopedics",
    transcript: "Came in with severe back pain and Dr. Rao diagnosed the issue quickly. He was honest about the recovery timeline and didn't oversell the treatment. I appreciate doctors who set realistic expectations rather than making empty promises.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Joshi",
    department: "Pediatrics",
    transcript: "Dr. Joshi is our family's pediatrician and we wouldn't go anywhere else. She knows our kids by name, remembers their medical history, and always makes time for our questions. The receptionist team is also wonderfully friendly.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Nair",
    department: "Neurology",
    transcript: "After my MS diagnosis, Dr. Nair has been my rock. She stays updated on the latest research and discusses new treatment options with me proactively. I never feel like just another patient — she treats me as a partner in my care.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Gupta",
    department: "Pediatrics",
    transcript: "Brought my newborn in for her first well-baby visit. Dr. Gupta was incredibly gentle and patient, explaining every developmental milestone we should watch for. She also took time to address my wife's breastfeeding concerns.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Sen",
    department: "Neurology",
    transcript: "Dr. Sen detected early signs of peripheral neuropathy that my previous doctor missed. He explained the condition clearly and started me on a treatment plan immediately. I'm grateful he caught it early.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Rao",
    department: "Orthopedics",
    transcript: "The cast removal process was quick and painless. Dr. Rao checked the healed fracture with an X-ray and was pleased with the result. He gave me clear instructions on gradually returning to my normal activities.",
    sentiment: "Positive",
  ...
  },
  {
    ...
    doctor_id: "Dr. Iyer",
    department: "Oncology",
    transcript: "Dr. Iyer delivered difficult news with remarkable sensitivity. He gave us time to process, answered every question we had, and connected us with the hospital's counseling service. His empathy during such a hard time meant the world to our family.",
    sentiment: "Positive",
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    doctor_id: "Dr. Nair",
    department: "Neurology",
    transcript: "My appointment went fine. Dr. Nair was professional but seemed a bit rushed during the consultation. The waiting room could use more comfortable seating, but overall no major complaints.",
    sentiment: "Neutral",
  ...
  },
  {
    ...
    doctor_id: "Dr. Gupta",
    department: "Pediatrics",
    transcript: "Dr. Gupta was good with my child but the appointment ran about 40 minutes late. I understand doctors get behind schedule, but some communication about the delay would have been appreciated.",
    sentiment: "Neutral",
  ...
  },
  {
    ...
    doctor_id: "Dr. Sen",
    department: "Neurology",
    transcript: "Dr. Sen is knowledgeable, no doubt about it. But the follow-up process could be better. I was told I'd get a call within two days with my test results, but had to call them myself after a week.",
    sentiment: "Neutral",
  ...
  },
  {
    ...
    doctor_id: "Dr. Joshi",
    department: "Pediatrics",
    transcript: "Decent visit overall. Dr. Joshi was friendly and the checkup was thorough. The only issue was that the hospital food in the cafeteria was quite bland — my son refused to eat it while we waited.",
    sentiment: "Neutral",
  ...
  },
  {
    ...
    doctor_id: "Dr. Rao",
    department: "Orthopedics",
    transcript: "Dr. Rao did a good job with my wrist examination. The X-ray technician was professional too. My only gripe is the uncomfortable chairs in the waiting area — not ideal when you're already in pain.",
    sentiment: "Neutral",
  ...
  },
  {
    ...
    doctor_id: "Dr. Nair",
    department: "Neurology",
    transcript: "Had a routine follow-up for my epilepsy medication. Dr. Nair reviewed everything and kept my current prescription. The visit itself was uneventful, which I suppose is a good thing. Nothing exceptional to report either way.",
    sentiment: "Neutral",
  ...
  },
  {
    ...
    doctor_id: "Dr. Sen",
    department: "Neurology",
    transcript: "The billing department lost my insurance information twice. I had to call back four times over two weeks to get it resolved. The medical care from Dr. Sen was fine, but the administrative side is absolutely terrible.",
    sentiment: "Negative",
